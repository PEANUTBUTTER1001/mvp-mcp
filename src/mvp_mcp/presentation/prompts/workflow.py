...
WORKFLOW_INSTRUCTIONS = (
    ...
    "1. 설문 Tool이 반환한 `spec_id`와 요청 기능을 사용한다. 별도로 `start_spec`, "
    "`answer_question`, `ask_next_web_question`을 호출하지 말고, 설문 뒤 추가 질문도 하지 마라.\n"
    ...
    "`proposal.md`에는 문제·사용자·가치·범위·지표·리스크, `plan.md`에는 유형별 화면/데이터/"
